...
ax = df.plot(x="x_count", y=["sliding_window_performance_0","sliding_window_performance_1",
                             "sliding_window_performance_2","sliding_window_performance_3","sliding_window_performance_4"],
             rot=30, linewidth=3, title=dataset)
ax.set_xlabel("")
ax.set_title("Performance on the %s dataset" % dataset)
ax.legend([r"$k$NN","HT","BIE", "KNNAdwin", "SGD"], loc='best')
